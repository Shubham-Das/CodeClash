...
<head>
    ...
    <title>Codebuzz - Placement</title>
                ...
                <div class="row">
                    <div class="col-lg-10 col-sm-9 d-none d-sm-block">
                        <ul class="mainmenu d-flex justify-content-end">
                            ...
                            <li class="active"><a href="#">placement</a>
                            </li>
    ...
    <div class="about-area position-relative">
        <div class="container">
            <div class="row">
                <div class="col1">
                    <ul>
                        <li><b>Google</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="placement.php?msg=<?php $message="Bag/Google.pdf"; echo $message;?>">Coding Papers</a></li>
                                <li><a href="placement.php?msg=<?php $message="Bag/Code.pdf"; echo $message;?>">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>Microsoft Corporation</b><i class="fa fa-angle-down" style="float: right"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>Amazon.com</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>Oracle Corporation</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>Internation Business Machine(IBM)</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>SAP(Systems, Applications & Products)</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>Tata Consultancy Services(TCS)</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                        </li>
                        <li><b>Symantec Corporation.</b><i class="fa fa-angle-down" style="float: right;"></i>
                            <ul>
                                <li><a href="#">Coding Papers</a></li>
                                <li><a href="#">MCQ Papers</a></li>
                            </ul>
                ...
                <div class="col2">
                    <embed src="<?php echo $_GET['msg'];?>" width="800px" height="1110px" />
                </div>
            </div>
        </div>
    </div>
