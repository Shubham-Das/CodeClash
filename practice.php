            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        <h2>Programming Tutorials and Practice Problems</h2>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <a href="practiceDemo.php">
                        <div class="practice-items">
                            ...
                            <p>Familiarize with Online Programming in just 7 easy steps</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 col-12">
                    <a href="practiceDemo.php">
                        <div class="practice-items">
                            ...
                            <h3>Code Monk</h3>
                            <p>Be better at programming just one step at a time.</p>
                        </div>
                    </a>
                </div>
            </div>
