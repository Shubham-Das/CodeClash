                        ...
                        <ul class="mainmenu d-flex justify-content-end">
                            ...
                            <li class="active"><a href="javascript:void(0);">blog <i class="fa fa-angle-down"></i></a>
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0);">Blog Categories</a></li>
                                </ul>
                            </li>
            ...
            <div class="row revarce-wrap">
                            ...
                            <ul>
                                <li class="post-item">
                                    ...
                                    <div class="post-content">
                                        <a href="blog-details.php">Digital Marketo Moved To Their New Office</a>
                                        <p>08 March 2017</p>
                                    </div>
                                </li>
                                <li class="post-item">
                                    ...
                                    <div class="post-content">
                                        <a href="blog-details.php">Welcome To Our New Head Of Production copy</a>
                                        <p>08 March 2017</p>
                                    </div>
                                </li>
                ...
                <div class="col-lg-8 col-12">
                    ...
                    <div class="blog-wrap">
                        ...
                        <div class="blog-content">
                            <h3><a href="blog-details.php">Digital Marketo Moved To Their Office</a></h3>
                            <ul>
                                <li><a href="#">Jhon Simith</a></li>
                                <li><a href="#">2 May, 2017</a></li>
                                <li><a href="#">Latest News</a></li>
